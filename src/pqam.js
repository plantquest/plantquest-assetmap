...
;(function(W, D) {
  ...
  function PlantQuestAssetMapInstance(id) {
    ...
    self.addBuildingControl = function () {
      ...
      self.current.buildingControl = new BuildingControl({
        position: 'topright'
      })
